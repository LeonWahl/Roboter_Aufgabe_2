...
//Hier wird geguckt, bei den gefundenen Linien die Punkte von den Türen auch enthalten sind
   ...
   std::vector<DoorRegion> doors={
        {"Flurtür_1", (-1.7705692052841187-0.5),(-1.7705692052841187+0.5) , (-33.61600875854492-0.5), (-33.61600875854492+0.5)},
        {"Flurtür_3", 0.9, 1.3, 1.3, 1.7},
        {"Flurtür_4", -0.6836, 0.3163, 1.2628, 2.2628}
